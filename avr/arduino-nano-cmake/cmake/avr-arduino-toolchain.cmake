...
#        set(ARDUINO_VARIANTS_PATH variants/atmega16a CACHE STRING "")
        ...
        add_definitions(-DARDUINO=10610)
        #add_definitions(-DARDUINO_AVR_UNO)
        add_definitions(-DARDUINO_AVR_MEGA)
...
function(target_sketch_libraryoffline TARGET NAME)
    setup_arduino_core()
    if (TARGET arduino-core AND NOT TARGET ${NAME})
        # try to install dependent libraries
        find_package(Git)
            ...
            # now add a library target
            file(GLOB_RECURSE libsources FOLLOW_SYMLINKS ${MYLIBS}/${NAME}/*.h ${MYLIBS}/${NAME}/*.S ${MYLIBS}/${NAME}/*.c ${MYLIBS}/${NAME}/*.cpp)
            # go through list of sources and remove the examples
            foreach (file ${libsources})
                STRING(REGEX MATCH "/examples/" example ${file})
                if (NOT example)
...
endfunction(target_sketch_libraryoffline)
