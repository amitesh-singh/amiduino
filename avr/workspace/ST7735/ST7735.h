...
public:
	...
	void 		drawHLine(uint8_t x0, uint8_t y, uint8_t x1, uint16_t color);
	void 		drawVLine(uint8_t x, uint8_t y0, uint8_t y1, uint16_t color);
	...
	void 		drawCircle(uint8_t posX, uint8_t posY, uint8_t r, uint16_t color);
	void 		fillCircle(uint8_t posX, uint8_t posY, uint8_t r, uint16_t color);
	void 		drawTriangle(); //TODO
	uint8_t 	drawChar(uint8_t charToWrite, uint8_t poX, uint8_t poY,
						 uint8_t size, unsigned int fgcolor);
