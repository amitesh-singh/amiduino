 ...
 */
#define USB_CFG_VENDOR_NAME     'a', 'm', 'i', '.', 'c', 'o', 'm'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'M', 'e', 'g', 'a', '1', '6', 'a'
 ...
 */
#define USB_CFG_DEVICE_CLASS        0 //CDC class is 2, if 0 given, it is decided by interface class.
